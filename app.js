...
var genesisblock = require('./config/genesisBlock.json');
...
var config = {
	...
	"modules": {
		"server": "./libs/server.js",
		"accounts": "./libs/accounts.js",
		"transactions": "./libs/transactions.js",
		"blocks": "./libs/blocks.js",
		"signatures": "./libs/signatures.js",
		"transport": "./libs/transport.js",
		"loader": "./libs/loader.js",
		"system": "./libs/system.js",
		"peer": "./libs/peer.js",
		"delegates": "./libs/delegates.js",
		"round": "./libs/round.js",
		"contacts": "./libs/contacts.js",
		"multisignatures": "./libs/multisignatures.js",
		"dapps": "./libs/dapps.js",
		"sia": "./libs/sia.js",
		"crypto": "./libs/crypto.js",
		"sql": "./libs/sql.js"
	}
};
